...
class DiffusionDecoderTests(unittest.TestCase):
    ...
    def test_resolve_state_dict_accepts_decoder_prefixed_keys(self):
        ...
        stripped_state = diffusion_decoder._resolve_state_dict(prefixed_state, model)

        self.assertEqual(set(stripped_state), set(model.state_dict()))
